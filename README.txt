...
This code relies on wolframscript to compute the STMs about some reference trajectory and store them into a file to be read in and used by the interpolater. The example shows how to call the wolframscript file and generate the neccessary data
